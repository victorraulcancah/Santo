...
CREATE TABLE `movcajag` (
  ...
  `de_prgchq` bit(1) NOT NULL DEFAULT b'0' COMMENT 'Flag que Indica que es un Movimiento de ProgramaciÃƒÂ³n',
...
INSERT INTO `ubigeo` (`codigo`,`dpto`,`prov`,`dist`) VALUES 
 ...
 ('050809              ','AYACUCHO                      ','PÀUCAR DEL SARA SARA          ','SAN JOSE DE USHUA                                 '),
