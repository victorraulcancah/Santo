...
$listaRamMasVen = $productoDao->getRandonRegister(15);
...
?>
    ...
    <style>
        ...
        @keyframes colorpalpitante {
            ...
            to {background-color: #ff324d; color: white}
        }
        <?php
        if ($body_class == 'desktop'){ ?>
        .menu-var{
...
<header class="header_wrap">
    ...
    <div style="background-color: black;" class="bottom_header dark_skin main_menu_uppercase border-top border-bottom">
                                            ...
                                            if (true){
                                                ...
                                                <li class="dropdown dropdown-mega-menu">
                                                    <a class="dropdown-item nav-link dropdown-toggler" href="#"
                                                       data-toggle="dropdown"><img style="max-width: 28px;" src="../public/iconos/<?=$catRow['icono']?>">
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            foreach ($resSUb as $rowMar) { ?>
                                                                                <li class=""> <strong><a class="dropdown-header"
                                                                                                         href="shop-list-ctg.php?ctg=<?=$catRow['codi_categoria']?>&sub=<?= $rowMar['sub_id'] ?>"><?= $rowMar['nombre'] ?></a></strong>
                                                                                </li>
                                                                            <?php }
                                                                            ?>
                	...
                	<nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
							<ul class="navbar-nav">
                                ...
                                <li class="dropdown dropdown-mega-menu">
                                    <a class="dropdown-toggle nav-link menu-var" href="#" data-toggle="dropdown">NOVEDADES</a>
                                    <div class="dropdown-menu">
                                        <ul class="mega-menu d-lg-flex">
                                            ...
                                            <li class="mega-menu-col col-lg-3">
                                                <ul> 
                                                    ...
                                                    foreach ($prodCatNv['productos'] as $itemProbn){
                                                        echo '<li><a style="overflow: hidden;text-overflow: ellipsis;" class="dropdown-item nav-link nav_item" href="shop-product-detail.php?prod='.$itemProbn['prod_id'].'">'.$itemProbn['nombre'].'</a></li>';
                                                    }
                                                    ?>
                                                </ul>
                                            </li>
                                ...
                                <li class="">
                                    <span class="nav-link" style="color: white;font-size: 11px;padding-left: 23px;">Tasa de cambio: <?=$tc?></span>
                                </li>
                            </ul>
                        </div>
                            ...
                            foreach ($dataConf['banner_pricipal'] as $rowBan){
                                ...
                                if (strlen($rowBan['prod'])>0){
                                    ...
                                    $dataExtraBann='<h4 class="staggered-animation mb-4 product-price" data-animation="slideInLeft" data-animation-delay="1.2s"><span class="price">$'.$PrecioProdBan.'</span></h4>
                                                <a class="btn btn-fill-out btn-radius staggered-animation text-uppercase" href="shop-product-detail.php?prod='.$rowBan['prod'].'" data-animation="slideInLeft" data-animation-delay="1.5s">Compra ahora</a>';
                                }
                                ?>
                                <div class="carousel-item <?=($countBan==1)?'active':''?> background_bg" data-img-src="../public/img/banner/<?=$rowBan['imagen']?>" style="">
	...
	<div class="custom-container">
    	<div class="row">
            <div class="col-xl-3 d-none d-xl-block">
                <div class="sale-banner">
                    <a class="hover_effect1" href="<?=$banerCprod1Prod?>">
                        <img src="../public/img/banner/<?=$banerCimg1Prod?>" alt="shop_banner_img6">
                    </a>
                </div>
            </div>
        	<div class="col-xl-9">
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_title" style="height: 40px;"><a style="white-space: normal" href="shop-product-detail.php?prod=<?=$proN['prod_id'] ?>"><?=$proN['nombre'] ?></a></h6>
                                    ...
                                    foreach ($listaRamMasVen as $itemMV){
                                        ...
                                        <div class="item">
                                            <div class="product_wrap">
                                                ...
                                                <div class="product_info">
                                                    <h6 class="product_title" style="height: 40px;"><a style="white-space: normal" href="shop-product-detail.php?prod=<?=$itemMV['prod_id'] ?>"><?=$itemMV['nombre'] ?></a></h6>
                                                    <div class="product_price">
                                                        <span class="price">$<?=$precioProd?></span>
                                                        <span> <strong>S/. <?php echo $precioCambio;?></strong></span>
                                                        <!--del>$15.00</del>
                                       ...
                                       <div class="deal_progress">
                                           <span class="stock-sold">
                                               ...
                                               <strong>Stock: <a href="javascript:void(0)"><?php
                                                       if ($ofeItem['stock']==0){
                                                           echo "<span style='font-weight: lighter;color: #d70000'>Sin Stock</span>";
                                                       }elseif($ofeItem['stock']>50){
                                                           echo "<span style='font-weight: lighter;color: #03ad01'>+ de 50 en Stock</span>";
                                                       }else{
                                                           echo  "<span style='font-weight: lighter;color: #03ad01'>" .number_format($ofeItem['stock'], 0, '.', ',') . " en Stock</span>";
                                                       }
                                                       ?></a></strong>
...
<div class="section small_pt small_pb">
	<div class="custom-container">
    	<div class="row">
            <div class="col-xl-3 d-none d-xl-block">
                <div class="sale-banner">
                    <a class="hover_effect1" href="<?=$banerCprod2Prod?>">
                        <img src="../public/img/banner/<?=$banerCimg2Prod?>" alt="shop_banner_img10">
                    </a>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                            ...
                            foreach ($listaRamTenden as $rowTem){
                                ...
                                $precioProdCambio =  number_format($rowTem['precio']*$tc, 2, '.', ',');
                                ?>
                                <div class="item">
                                    <div class="product_wrap">
                                        <div class="product_img">
                                        ...
                                        <div class="product_info">
                                            <h6 class="product_title" style="height: 40px;"><a style="white-space: normal" href="shop-product-detail.php?prod=<?=$rowTem['prod_id'] ?>"><?=$rowTem['nombre'] ?></a></h6>
                                            <div class="product_price">
                                                <span class="price">$<?=$precioProd?> </span>
                                            ...
                                            <div class="rating_wrap">
                                                ...
                                                <span class="rating_num"><strong>Stock: <a href="javascript:void(0)"><?php
                                                            if ($rowTem['stock']==0){
                                                                echo "<span style='font-weight: lighter;color: #d70000'>Sin Stock</span>";
                                                            }elseif($rowTem['stock']>10){
                                                                echo "<span style='font-weight: lighter;color: #03ad01'>+ de 10 en Stock</span>";
                                                            }else{
                                                                echo  "<span style='font-weight: lighter;color: #03ad01'>" .number_format($rowTem['stock'], 0, '.', ',') . " en Stock</span>";
                                                            }
                                                            ?></a></strong>
                                                </span>
                                            </div>
...
<a href="https://m.me/<?=$dataConf['redessociales']['id_facebook']?>" id="botn_facebook" class="float2" target="_blank">
