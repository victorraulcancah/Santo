...
$sqlEXTERNO = "SELECT * FROM delivery_pasos WHERE tipo='I' ORDER BY num_paso ASC ";
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb justify-content-md-end">
                    ...
                    <li class="breadcrumb-item active">Delivery Cañete</li>
                </ol>
            </div>
        </div>
    </div><!-- END CONTAINER-->
...
<div class="main_content">
    ...
    <?php include "../fragment/content_envios.php"?>
</div>
<!-- END MAIN CONTENT -->
