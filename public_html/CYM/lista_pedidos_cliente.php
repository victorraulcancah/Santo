...
foreach ($lista_ped as $i => $row_pd) {
    ...
    $htmlTd .=  "<tr style=''>
            ...
            <td class='text-center' style=' font-size:12px;padding:5px'> 12 meses </td>
...
$htmlCuadroHead = "<div style=' width: 34%;text-align: center; background-color: #ffffff ; float: right;'>
            ...
            <div style='margin-top: 10px'></div>
            <span><strong>RUC: 20613235168</strong></span><br>
            <div style='margin-top: 10px'></div>
            <span> </span>
            </div>
            </div>
            </div>";
    $direccion = "Av Bolivia 180 int 318 tercer piso, Lima, Peru";
    $mpdf->WriteFixedPosHTML("<img style='max-width: 300px;max-height: 95px' src='../public/images/cym.png'>", 15, 5, 150, 120);
    $mpdf->WriteFixedPosHTML($htmlCuadroHead, 0, 5, 195, 130);
    //$mpdf->WriteFixedPosHTML("<span style=' font-size: 12px'><strong>RUC: </strong> 20613235168</span>", 18, 27, 210, 130);
    $mpdf->WriteFixedPosHTML("<span style=' font-size: 12px'><strong>Empresa: </strong> Ace Advance Group S.A.C</span>", 18, 32, 210, 130);
    $mpdf->WriteFixedPosHTML("<span style=' font-size: 12px'><strong>Dirección:</strong> <span style='font-size: 10px'> {$direccion}</span></span>", 18, 37, 120, 130);
    ...
    <div style='padding: 0 70px'>
        <div style='margin-top:10px'>
            <div class='table-responsive-sm' style='width: 100%;'>
                <table class='table table-responsive' style='width: 100%;margin-left:0%'>
                    <thead>
                        <tr>
                    ...
                    <tbody style>
                        ...
                        <tr>
                             <td style='background-color:white;font-size:11px; text-transform: uppercase;padding:5px 0 5x 10px'>N. Doc.: {$ndoc}</td>
                        </tr>
                        <tr>
                             <td style='background-color:white;font-size:11px; text-transform: uppercase;padding:5px 0 5x 10px'>Fecha: {$fecha}  </td>
                        </tr>
                        <tr style=''>
					 <td style='background-color:white;font-size:11px; text-transform: uppercase;padding:5px 0 5x 10px;  border-bottom: 1px solid #1e1e1e'>Celular: {$celular}  </td>
                        </tr>
                    </tbody>
		    ...
		    <div style='border: 3px solid white;border-radius: 10px 10px 10px 10px;position: relative;margin: -10px 0 0 80px;width: 200px' id='large-div-text'>
                        <p style='font-weight:bold;padding: 0px 0 0 55px'></span></p>
                </div>
