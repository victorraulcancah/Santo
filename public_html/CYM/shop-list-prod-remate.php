                                ...
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title titulo_prod"><a
                                                :href="'shop-product-detail-remate.php?prod='+item.prod_id">{{item.nombre}}</a>
                                        </h6>
                                        ...
                                        <div class="rating_wrap">
                                            ...
                                            <span class="rating_num">
                                                <strong>Stock: <a href="javascript:void(0)">
                                                        <span v-if="formartNumberStock(item.stock_prod)==0"
                                                            style="font-weight: lighter;color: #d70000"> Sin
                                                            Stock</span>
                                                        <span
                                                            v-if="formartNumberStock(item.stock_prod)<=10&&formartNumberStock(item.stock_prod)>0"
                                                            style="font-weight: lighter;color: #03ad01">
                                                            {{formartNumberStock(item.stock_prod)}} en Stock</span>
                                                        <span v-if="formartNumberStock(item.stock_prod)>10"
