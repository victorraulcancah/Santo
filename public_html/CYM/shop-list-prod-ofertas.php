                                ...
                                <div class="product">
                                    ...
                                    <div class="product_info">
                                        <h6 class="product_title titulo_prod"><a
                                                :href="'shop-product-detail.php?ofer=cyv&prod='+item.prod_id">{{item.nombre}}</a>
                                        </h6>
                                        ...
                                        <div style="font-size: 14px;" class="product_price">
                                            <span class="price">S/.
                                                {{getCamBio(formatNumerPrecio(item.precio_oferta))}}</span>
                ...
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <div class="newsletter_text text_white">
                            ...
                            <p>Recibe las mejores Ofertas en Laptop y Perifericos SUSCR&Iacute;BETE</p>
                        </div>
                    </div>
                    <div class="col-md-6">
