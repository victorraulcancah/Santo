            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb justify-content-md-end">
                        ...
                        <li style="font-size: 18px;color: #ff3d57;">TC: <span style="color: white">-</span>
                            <strong><?= $tc ?></strong></li>
                    </ol>
                </div>
            </div>
                                    ...
                                    <div class="product_img">
                                        ...
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart titulo_prod"><a
                                                        v-on:click="agregarCarritoProd(index)"
            ...
            getDataProdListaPag2() {
                ...
                $.ajax({
                    ...
                    success: function (resq) {
                        ...
                        // Aplicar filtrado inmediato para excluir productos sin stock
                        APP_PROD.resetFiter();
                    ...
                    if (precioProd >= this.valueUSDMin && precioProd <= this.valueUSDMax) {
                        if (this.listaMarcaFiltro.length > 0) {
                            if (this.listaMarcaFiltro.indexOf(this.listaProdGene[i].marca) != -1) {
                                // Siempre mostrar solo productos con stock > 0
