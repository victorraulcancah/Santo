                            ...
                            <div class="collapse navbar-collapse mobile_side_menu" id="navbarSidetoggle">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <ul>
                                                <li><a class="dropdown-item nav-link nav_item" href="./shop-list-ctg.php?ctg=010">Vino Tinto</a></li>
                                                <li><a class="dropdown-item nav-link nav_item" href="./shop-list-ctg.php?ctg=005">Vino Blanco</a></li>
                                                <li><a class="dropdown-item nav-link nav_item" href="./shop-list-ctg.php?ctg=001">Vino Rosado</a></li>
                                                <li><a class="dropdown-item nav-link nav_item" href="./shop-list-ctg.php?ctg=002">Espumante</a></li>
                                                <li><a class="dropdown-item nav-link nav_item" href="./shop-list-ctg.php?ctg=012-014">Pisco</a></li>
