...
class ConsultasController extends Controller
{
  ...
  estado='1'";
    ...
    public function verificadorToken()
    {
	  ...
	  // Validar sistema_id
        if ($token_data['sistema_id'] !== $sistema_id) {
            //throw new Exception("Token de sistema incorrecto");
		$respuesta = ["res" => false];
        }  elseif (time() - $token_data['timestamp'] > 3600) {
		// Validar tiempo de vida (ejemplo: 1 hora)
